...
(function(){
  ...
  /* Which of the three reads as current, taken from the page itself rather than
     ...
     was survivable while Index and Library went nowhere; now that all three
     navigate, every other page would have shown Index as the one you were on. */
  (function(){
